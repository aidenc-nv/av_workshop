...
COSMOS_REF="${COSMOS_REF:-c393826e69945b5b405b12466406680cf9b334eb}"
...
#   apt-get update -y
#   apt-get install -y curl ffmpeg tree wget python3 python3-venv
...
###############################################
# 7/7 — SAM3 INSTALL (clone only if missing) #
###############################################

echo "[7/7] Installing SAM3..."
